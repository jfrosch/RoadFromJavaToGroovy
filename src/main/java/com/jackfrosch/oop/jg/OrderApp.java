package com.jackfrosch.oop.jg;

import com.jackfrosch.oop.g.LineItem;
import com.jackfrosch.oop.g.Order;
import com.jackfrosch.oop.g.OrderService;
...
public class OrderApp {
    ...
    private Order createOrder() {
        Order order = new Order("Test - JG", "88888-1234");
        order.addLineItem(new LineItem("Prod_A", new BigDecimal("10.00"), 1, true))
             .addLineItem(new LineItem("Prod_B", new BigDecimal("15.00"), 2, false))
             .addLineItem(new LineItem("Prod_C", new BigDecimal("20.00"), 3, true));
        return order;
    }
